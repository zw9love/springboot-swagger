...
import com.roncoo.swagger.bean.ResObject;
import com.roncoo.swagger.bean.User1;
...
//    @ApiOperation(value = "新增用户" ,  notes="新增注册")
    ...
    public ResObject createUser(@RequestBody User1 user){
...
//    @ApiOperation(value = "修改用户" ,  notes="修改用户")
    ...
    public ResObject updateUser(@RequestBody User1 user){
...
//    })
    ...
    public ResObject queryUser(@RequestParam("userId") String userId){
        ...
        User1 user = new User1(userId, "张三", "******", "mao2080@sina.com");
